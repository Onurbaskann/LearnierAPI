...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<ICreditQueries, EfCreditQueries>();

        // Rezervasyon hakki aboneliklere ve kredi defterine gore belirlenir.
        // Kural Application katmaninda; burada yalnizca kaydi yapiliyor.
        services.AddScoped<IBookingEntitlementPolicy, SubscriptionEntitlementPolicy>();
